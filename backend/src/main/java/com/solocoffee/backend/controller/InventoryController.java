...
public class InventoryController {
    ...
    public ResponseEntity<ApiResponse<Inventory>> updateInventoryQuantity(@PathVariable Long id, @RequestParam BigDecimal quantity) {
    ...
    public ResponseEntity<ApiResponse<Inventory>> updateInventoryByProductId(@PathVariable Long productId, @RequestBody Inventory inventory) {
    ...
    public ResponseEntity<ApiResponse<Inventory>> reduceInventory(@RequestBody java.util.Map<String, Object> request) {
        ...
        java.math.BigDecimal quantity = java.math.BigDecimal.valueOf(Double.valueOf(request.get("quantity").toString()));
