...
public class CustomerController {
    ...
    public ResponseEntity<ApiResponse<?>> getAllCustomers(
        ...
        Map<String, Object> customers = customerService.getCustomersWithFilter(page, size, keyword, levelId);
    ...
    public ResponseEntity<ApiResponse<Customer>> addPoints(@PathVariable Long id,
    ...
    public ResponseEntity<ApiResponse<Customer>> redeemPoints(@PathVariable Long id,
            @RequestBody Map<String, Object> request) {
        Integer points = ((Number) request.get("points")).intValue();
        Integer type = ((Number) request.get("type")).intValue();
        Long relatedId = Long.valueOf(request.get("relatedId").toString());
